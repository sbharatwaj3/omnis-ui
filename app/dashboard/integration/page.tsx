...
//
// Animation contract (animation-standards.md):
//   - Main container: fade-in + y:[4→0], tween easeOut 0.35s
//   - Steps staggered via variants with 0.08s inter-step delay
//   - No spring/bounce — institutional, fast, zero elasticity
...
export default function IntegrationPage() {
  return (
    <div className="min-h-screen bg-zinc-50">
      ...
      {/* -- Main ---------------------------------------------------------- */}
      {/*
       * pageVariants handles the outer fade+translate so the whole content
       * area slides in as one cohesive unit rather than individual fragments.
       */}
      <motion.main
        className="mx-auto max-w-7xl w-full px-6 py-8 md:px-8 md:py-12"
      ...
      >
        ...
        {/*
         * staggerContainer drives the sequential reveal of the three setup
         * steps (sections). Each <motion.section> picks up stepItem.
         */}
        <motion.div
        ...
        >
          ...
          >
            ...
            <div className="rounded border border-zinc-200 bg-white p-5">
              ...
              {/* env var blocks — inner stagger for the three command variants */}
              <motion.div
                className="space-y-2"
                variants={staggerContainer}
                initial="hidden"
          ...
          >
            ...
            {/* Command blocks — staggered inner reveal */}
            <motion.div
              className="space-y-4"
              variants={staggerContainer}
              initial="hidden"
          ...
          {/* -- Done CTA ------------------------------------------------ */}
          <motion.div
            className="rounded border border-emerald-200 bg-emerald-50 px-5 py-4"
            variants={stepItem}
          >
