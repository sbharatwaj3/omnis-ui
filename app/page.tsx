      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-6 py-4">
        <Link href="/" className="flex shrink-0 items-center gap-2.5 group">
          ...
          <div className="leading-none">
            <span className="block text-sm font-bold tracking-tight text-slate-900">Omnis MedTech Corp</span>
            <span className="block text-[10px] font-medium tracking-widest text-emerald-600 uppercase">RegOps Platform</span>
          </div>
        </Link>
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mx-auto max-w-5xl overflow-hidden rounded-2xl border border-slate-200 shadow-2xl shadow-slate-200/60">
          ...
          <div className="flex items-center gap-2 border-b border-slate-100 bg-white px-5 py-3">
            ...
            <span className="text-xs font-semibold text-slate-700">Omnis RegOps</span>
