...
export function DashboardClient({ allRows, initialViewMode = "grouped", previewLimit }: DashboardClientProps) {
  ...
  return (
    <>
      ...
      {/* ── AI ROI Metric Bento ─────────────────────────────────────────────
          Three stat cards that surface the measurable value of the Bedrock
          AI integration. Rendered beneath the Evidence Log table so the
          3-column grid aligns flush with the table width above it.
          Design system: border ≤ 4px radius, no drop shadows, flat elevation. */}
      <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-3">

        {/* Card 1: False Positives Cleared */}
        <div className="rounded border border-slate-200 bg-white p-4">
          ...
          <p className="mt-1 text-xs text-slate-400">
            Auto-triaged by Bedrock AI
          </p>
        </div>

        {/* Card 2: QA Hours Saved */}
        <div className="rounded border border-slate-200 bg-white p-4">
          <p className="text-[10px] font-semibold uppercase tracking-widest text-slate-400">
            QA Hours Saved
          </p>
          ...
          <p className="mt-1 text-xs text-slate-400">
            Based on manual review baseline
          </p>
        </div>

        {/* Card 3: Bedrock API Latency */}
        <div className="rounded border border-slate-200 bg-white p-4">
          <p className="text-[10px] font-semibold uppercase tracking-widest text-slate-400">
            Bedrock API Latency
          </p>
