...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\footnotesize \textbf{Omnis MedTech Corp} \textbar{} Omnis RegOps Platform}
\fancyhead[R]{\footnotesize OMNIS-RTM-2026-001 \textbar{} Confidential}
  ...
  \ifnum\value{landscapemode}=1
    ...
    \AtPageLowerLeft{%
      \put(524, 72){%
        \rotatebox{90}{%
          \makebox[648pt][l]{%
            \footnotesize\textbf{Omnis MedTech Corp} \textbar{} Omnis RegOps Platform%
          }%
        }%
      }%
    }%
    ...
    \AtPageLowerLeft{%
      \put(524, 72){%
        \rotatebox{90}{%
          \makebox[648pt][r]{%
            \footnotesize OMNIS-RTM-2026-001 \textbar{} Confidential%
          }%
        }%
      }%
    }%
...
\begin{titlepage}
    ...
    {\Large \textbf{Omnis MedTech Corp} \par}
    \vspace{1.2cm}

    {\huge \textbf{Omnis RegOps Platform} \par}
    \vspace{0.6cm}
    ...
    \begin{tabular}{>{\bfseries}p{4.5cm} p{9.0cm}}
        \toprule
        Document ID:        & OMNIS-RTM-2026-001 \\[4pt]
        Document Title:     & Omnis RegOps Platform Software Documentation Attachment \\[4pt]
        ...
        Company:            & Omnis MedTech Corp \\[4pt]
        Date Generated:     & June 12, 2026 \\[4pt]
    ...
    \begin{minipage}{0.85\textwidth}
        ...
        review process for \textbf{Omnis RegOps Platform} and provides comprehensive
...
software functions for \textbf{Omnis RegOps Platform}, including safety, effectiveness,
...
\begin{itemize}
    \item \textbf{Omnis MedTech Corp} has established and maintains policies,
...
\bottomrule
\endlastfoot
Test User & Dev & 2026-06-12 & Approval & abc123 \\
\end{longtable}
...
\textbf{Omnis RegOps Platform} as a software as a medical device (SaMD). This
...
\textbf{Omnis RegOps Platform}, including:
\begin{itemize}
...
\textbf{Omnis RegOps Platform}. Reference the ISO~14971 risk management file and
...
Indicate whether \textbf{Omnis RegOps Platform} meets FDA's definition of a
\textit{cyber device} in accordance with Section~524B of the FD\&C Act and
associated FDA guidance.

\begin{itemize}
    \item If \textbf{Omnis RegOps Platform} is a cyber device, state this explicitly
          and reference the specific criteria met.
    \item If \textbf{Omnis RegOps Platform} is not considered a cyber device, provide
...
\begin{itemize}
    ...
    \item SBOM data is integrated into vulnerability management and risk
          assessment processes for \textbf{Omnis RegOps Platform}.
\end{itemize}
...
\textbf{Omnis RegOps Platform} and documents their intended use, safety
...
\subsection{Overview}
\textbf{Omnis RegOps Platform} uses automated CI/CD pipelines and AI-driven anomaly
...
software lifecycle artifacts and test evidence for \textbf{Omnis RegOps Platform}.
...
\endlastfoot
IEC-62304 & Req & Core & LOG & TC & PASS & --- \\
\end{longtable}
\normalsize
...
\vspace{0.3cm}
{\small\textit{Auto-generated on \textbf{June 12, 2026}. Doc
ID:~\texttt{OMNIS-RTM-2026-001}. Per IEC~62304 Clause~6.2.5, this RTM must be
...
\endlastfoot
1.0 & June 12, 2026 &
    Initial automated generation for \textbf{Omnis RegOps Platform}. &
    CI/CD Pipeline \\
\end{longtable}
